...
```json
{"id":"calendarItem","component":"Row","children":["eventTime","eventTitle"],"onClick":[{"call":"clickToIntent","args":{"intentName":"ViewCalendarEvent","params":{"entityId":"{{ $event.entityId }}"}}}]}
```
