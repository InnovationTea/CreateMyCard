...
{
  "title": "TRE-077 测试卡片",
  "description": "候选路径存在但TaskSpec缺叶子必须失败。",
  "suggestSize": "2x2",
  "dataBindings": [
    {
...
{"version":"v0.9","updateDataModel":{"surfaceId":"surface_card","path":"/","value":{"data":{"healthSport":{"_templateProjection":{"SleepOverview":{"nightSleepDurationText":"7小时1分","sleepDurationPrimaryValueText":"7","sleepDurationPrimaryUnitText":"小时","sleepDurationSecondaryValueText":"1","sleepDurationSecondaryUnitText":"分钟"}},"nightSleepDurationText":"7小时1分"}}}}}
```
```schema
{
...
```meta
{
  ...
  "artifactId": "9ddf9a34-f724-4c4c-9c75-64529d910723",
  "createdAt": 1787203317436
}
```
```designcompactdsl
...
["/",{"data":{"healthSport":{"_templateProjection":{"SleepOverview":{"nightSleepDurationText":"7小时1分","sleepDurationPrimaryValueText":"7","sleepDurationPrimaryUnitText":"小时","sleepDurationSecondaryValueText":"1","sleepDurationSecondaryUnitText":"分钟"}},"nightSleepDurationText":"7小时1分"}}}]
```
