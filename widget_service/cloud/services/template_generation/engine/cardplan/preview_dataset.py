...
_ASSET_BY_PARAMETER = {
    ...
    "reminderIcon": "resources/base/media/bell_fill.svg",
...
_SAMPLE_BY_BUSINESS_BINDING: dict[tuple[str, str], Any] = {
    ...
    ("BluetoothDeviceOverview", "updated"): "今天 09:30",
    ...
    ("CalendarOverview", "meetingLink"): "huawei-meeting://join/10086",
    ("CalendarOverview", "reminder"): 15,
    ("CalendarOverview", "sender"): "张三",
