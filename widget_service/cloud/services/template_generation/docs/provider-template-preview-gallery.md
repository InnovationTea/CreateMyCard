...
数据集覆盖 75 个业务模板，不包含 10 个布局模板：

- Compact：29 个，使用 2×2 卡片容器，模板内容高度 68vp。
- Hero：7 个，使用 2×2 卡片容器，模板内容高度 124vp。
- Full：26 个，使用 2×2 卡片容器，模板内容高度 136vp。
...
- `T001.json` 至 `T075.json`：每个模板独立的 A2UI 消息数组，固定包含 `createSurface`、
