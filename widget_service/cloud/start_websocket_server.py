...
def create_app() -> FastAPI:
    ...
    fastapi_app.mount("/api/v1/artifacts", StaticFiles(directory=str(mock_obs_dir)), name="artifacts")
    logger.info(f"{_MODULE} static_files_mounted path=/api/v1/artifacts directory={mock_obs_dir}")
