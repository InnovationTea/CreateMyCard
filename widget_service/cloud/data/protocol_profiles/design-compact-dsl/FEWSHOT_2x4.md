...
2x4 最终恰好两个业务数据块时，若业务组合与 V09 的天气+手机电量示例一致，可以参考 V09 的内容组织；其它业务组合只参考本尺寸的 W9 结构硬约束，不复制 V09 的业务语义。root 必须是 Row，并直接使用左右两个 `134×126vp` 大内容背板，不生成公共标题、公共内容区或公共按钮行，每个业务的数据和按钮只放在所属背板内。禁止复用 2x2 S4，禁止 `root Stack -> content Column`，禁止生成上下两个 `276×59vp` 背板或任何其它上下双业务布局。
...
["main","Row",{"width":276,"height":103,"itemMargin":8,"alignItems":"center"},["ringArea","info"]]
["ringArea","Column",{"width":134,"height":103,"justifyContent":"center","alignItems":"center"},["ringStack"]]
...
["info","Column",{"width":134,"height":103,"itemMargin":4,"justifyContent":"center"},["infoTitle","level","status"]]
...
```
## 示例十一（2x4-V04）：今日步数与双详情（W1-focus-aux·var-a 双份区域·绿色微渐变）
### user
```json
{"userQuery":"帮我做张今日运动卡片，主要看今天走了多少步，也想看看行走距离和消耗热量。","size":"2x4","eventCandidates":[],"assetCandidates":[],"dataModelSchema":{"data":{"healthSport":{"dailySteps":{"type":"integer","description":"今日累计步数","sampleValue":6200},"dailyDistanceText":{"type":"string","description":"包含单位的今日行走距离","sampleValue":"4.60 公里"},"dailyTotalCaloriesText":{"type":"string","description":"包含单位的今日总消耗热量","sampleValue":"260 千卡"}}}}}
```
### assistant
```genui
["root","Row",{"width":"matchParent","height":"matchParent","padding":12,"borderRadius":20,"clip":true,"itemMargin":10,"justifyContent":"center","alignItems":"center","linearGradient":{"direction":"RightBottom","colors":[["#FFCCFFDD",0],["#FFF2FFF6",1]]}},["hero","details"]]
["hero","Column",{"width":136,"height":126,"itemMargin":4,"justifyContent":"center","alignItems":"start"},["valueRow","label"]]
["valueRow","Row",{"width":136,"itemMargin":4,"alignItems":"bottom"},["value","unit"]]
["value","Text",{"content":{"path":"/data/healthSport/dailySteps"},"fontSize":30,"fontWeight":700,"fontColor":"#FF1C8C41","maxLines":1}]
["unit","Text",{"content":"步","fontSize":12,"fontWeight":400,"fontColor":"#FF1C8C41","padding":{"bottom":4},"maxLines":1}]
["label","Text",{"content":"今日步数","width":136,"fontSize":12,"fontWeight":400,"fontColor":"#FF1C8C41","maxLines":1}]
...
["nightLabel","Text",{"content":"行走距离","width":110,"fontSize":12,"fontWeight":400,"fontColor":"#FF1C8C41","maxLines":1}]
["nightValue","Text",{"content":{"path":"/data/healthSport/dailyDistanceText"},"width":110,"fontSize":12,"fontWeight":400,"fontColor":"#FF1C8C41","maxLines":1}]
...
["deepLabel","Text",{"content":"消耗热量","width":110,"fontSize":12,"fontWeight":400,"fontColor":"#FF1C8C41","maxLines":1}]
["deepValue","Text",{"content":{"path":"/data/healthSport/dailyTotalCaloriesText"},"width":110,"fontSize":12,"fontWeight":400,"fontColor":"#FF1C8C41","maxLines":1}]
["/data/healthSport/dailySteps",6200]
["/data/healthSport/dailyDistanceText","4.60 公里"]
["/data/healthSport/dailyTotalCaloriesText","260 千卡"]
```
...
["metric0","Column",{"width":89,"height":84,"itemMargin":4,"justifyContent":"center","alignItems":"center"},["value0","label0"]]
["label0","Text",{"content":"睡眠得分","width":89,"fontSize":12,"fontWeight":400,"fontColor":"#FF1C8C41","textAlign":"center","maxLines":1}]
["value0","Text",{"content":"{{ ${/data/healthSport/sleepScore} + '分' }}","width":89,"fontSize":18,"fontWeight":700,"fontColor":"#FF1C8C41","textAlign":"center","maxLines":1}]
["sep0","Divider",{"width":1,"height":59,"vertical":true,"color":"#331C8C41"}]
["metric1","Column",{"width":89,"height":84,"itemMargin":4,"justifyContent":"center","alignItems":"center"},["value1","label1"]]
["label1","Text",{"content":"消耗热量","width":89,"fontSize":12,"fontWeight":400,"fontColor":"#FF1C8C41","textAlign":"center","maxLines":1}]
["value1","Text",{"content":{"path":"/data/healthSport/dailyTotalCaloriesText"},"width":89,"fontSize":18,"fontWeight":700,"fontColor":"#FF1C8C41","textAlign":"center","maxLines":1}]
["sep1","Divider",{"width":1,"height":59,"vertical":true,"color":"#331C8C41"}]
["metric2","Column",{"width":89,"height":84,"itemMargin":4,"justifyContent":"center","alignItems":"center"},["value2","label2"]]
["label2","Text",{"content":"今日步数","width":89,"fontSize":12,"fontWeight":400,"fontColor":"#FF1C8C41","textAlign":"center","maxLines":1}]
["value2","Text",{"content":"{{ ${/data/healthSport/dailySteps} + '步' }}","width":89,"fontSize":18,"fontWeight":700,"fontColor":"#FF1C8C41","textAlign":"center","maxLines":1}]
...
["phoneValue","Text",{"content":{"path":"/data/phoneBattery/batterySOCText"},"width":110,"fontSize":14,"fontWeight":700,"fontColor":"#FF1F4799","maxLines":1}]
...
["weatherValue","Text",{"content":"{{ ${/data/weather/current/temperatureC} + '°C' }}","width":110,"height":34,"fontSize":24,"fontWeight":700,"fontColor":"#FF1F4799","maxLines":1}]
...
["weatherContent","Column",{"width":110,"layoutWeight":1,"itemMargin":2,"justifyContent":"center"},["weatherLabel","weatherReadout","weatherStatus"]]
["weatherReadout","Row",{"width":110,"height":42,"alignItems":"bottom","itemMargin":2},["weatherValue","weatherUnit"]]
...
```genui
["root","Stack",{"width":"matchParent","height":"matchParent","borderRadius":20,"clip":true,"linearGradient":{"direction":"RightBottom","colors":[["#FFCCFCFF",0],["#FFF2FEFF",1]]}},["content"]]
["content","Column",{"width":"matchParent","height":"matchParent","padding":12,"itemMargin":2,"justifyContent":"start","alignItems":"start"},["header","body","cta"]]
...
["statusGroup","Column",{"width":276,"height":42,"itemMargin":2,"justifyContent":"center","alignItems":"start"},["status","name"]]
["status","Text",{"content":"{{ ${/data/earphone/isConnected} ? '已连接' : '未连接' }}","width":276,"height":24,"fontSize":18,"fontWeight":700,"fontColor":"#FF1C838C","maxLines":1}]
["name","Text",{"content":{"path":"/data/earphone/earphoneName"},"width":276,"height":16,"fontSize":14,"fontWeight":500,"fontColor":"#FF1C838C","maxLines":1}]
["battery","Text",{"content":"{{ '左耳 ' + ${/data/earphone/leftBatteryLevel} + '% | 右耳 ' + ${/data/earphone/rightBatteryLevel} + '%' }}","width":276,"height":20,"fontSize":12,"fontWeight":400,"fontColor":"#991C838C","maxLines":1}]
["cta","Button",{"label":"蓝牙设置","width":276,"height":36,"borderRadius":18,"backgroundColor":"#331C838C","fontColor":"#FF1C838C","fontSize":14,"fontWeight":400,"onClick":[{"call":"clickToDeeplink","args":{"intentName":"Settings","bundleName":"com.huawei.hmos.settings","abilityName":"com.huawei.hmos.settings.MainAbility","uri":"bluetooth_entry"}}]}]
["/data/earphone/isConnected",true]
