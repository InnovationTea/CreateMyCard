...
from widget_service.models.capability import (
    DataCapability,
    RemovedCapability,
)
from widget_service.models.generation import (
...
class AssetCandidateOverview(BaseModel):
    id: str
    src: str
    description: str
...
class CapabilityOverviewResponse(BaseModel):
    ...
    assetCandidates: list[AssetCandidateOverview]
